goog.provide('recoil.structs.table.UnionTest');

goog.require('goog.testing.jsunit');
goog.require('recoil.structs.table.Union');
...
function testUniqueKey() {
    ...
    var testee = new recoil.structs.table.Union(true,false);
...
function testConcatKey() {
    ...
    var testee = new recoil.structs.table.Union(true,false, srcCol, [':0',':1']);
...
function testRemoveDupes() {
    ...
    var testee = new recoil.structs.table.Union(true,true);
...
function testAllowDupes() {
    ...
    var testee = new recoil.structs.table.Union(false, false);
