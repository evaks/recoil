...
function testExpand() {
    ...
    expected = [
        [{val:"a1", col: COL_A}, {val: 1, col : COL_B},{val:null, col: COL_C}],
        [{val:"a2", col: COL_A}, {val: 2, col : COL_B},{val:{c1: "fred2", c2:"c.2.2", c3:"c.3.2"},col: COL_C}],
        [{val:"a3", col: COL_A}, {val: 3, col : COL_B},{val:null, col: COL_C}],
    ...
    expected = [
        [{val:"a1", col: COL_A}, {val: 6, col : COL_B},{val:{c1: "c1def", c2:"c2set"}, col: COL_C}],
        [{val:"a2", col: COL_A}, {val: 2, col : COL_B},{val:{c1: "fred2", c2:"c.2.2", c3:"c.3.2"},col: COL_C}],
        [{val:"a3", col: COL_A}, {val: 3, col : COL_B},{val:null, col: COL_C}],
        [{val:"a4", col: COL_A}, {val: 4, col : COL_B},{val:{c1:"c.1.4", c2:"c.2.4",c3:'c.3.4'}, col: COL_C}],
     ];
